...
#   ./start_data_collector.sh --rotation_input_frame eef   # 旋转输入按末端系解释（默认）
#   ./start_data_collector.sh --rotation_input_frame base  # 旋转输入按基座系解释
#   ./start_data_collector.sh --input_device ps4      # 使用 PS4 二代手柄
#   ./start_data_collector.sh --input_device ps4 --rotation_input_frame eef
